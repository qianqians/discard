...
def gen_module_caller(module_name, funcs, dependent_struct, dependent_enum):
    ...
    cb_code += "    class rsp_cb_" + module_name + " : public Imodule, public std::enable_shared_from_this<rsp_cb_" + module_name + ">{\n"
    cb_code += "    public:\n"
    cb_code_constructor = "        rsp_cb_" + module_name + "() : Imodule(\"rsp_cb_" + module_name + "\")\n"
    cb_code_constructor += "        {\n"
    cb_code_constructor += "        }\n\n"
