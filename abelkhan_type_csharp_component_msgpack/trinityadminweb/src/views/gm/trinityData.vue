      ...
      <el-card class="box-card">
        ...
        <div style="margin-bottom:50px;">
          <el-col :span="4" class="text-center">
            <el-button class="pan-btn pink-btn" @click="handleDispatcher('DataOk', '')">
              ok测试
            </el-button>
          </el-col>
          <el-col :span="4" class="text-center">
            <el-button class="pan-btn yellow-btn" @click="handleDispatcher('DataOk', '')">
              服务reload
            </el-button>
          </el-col>
        </div>
  ...
  data() {
    ...
    return {
      cmd: {
        cmdName: '',
        param: '',
        svrName: this.$route.params.name || 'data0',
        svrType: this.$route.params.type || 'data'
      },
      demo: {
        title: ''
      },
