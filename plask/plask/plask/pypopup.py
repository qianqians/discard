...
def close_pop():
	return "if (popobj != null){document.body.removeChild(popobj);\ndocument.body.removeChild(poptable);\npoptable = null;\npopobj = null;\n}"
...
class pypopup(pyelement):
	...
	def flush(self):
		...
		js += " table.style.top = ((iHeight-table.offsetHeight)/2).toString()+\"px\";\n"
		js += " msgObj.style.top = (((iHeight-table.offsetHeight)/2)-10).toString()+\"px\";\n"
