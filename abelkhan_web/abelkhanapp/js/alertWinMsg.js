function alertWinMsg(text){
    ...
    table_text_1.style.textAlign="center";
    table_text_1.style.paddingTop="4px";
...
/*
<div style="background-color:rgb(255,255,255); margin:10px auto auto auto; clear:both;">
    <div username="浅浅" onmouseout="mouseoutuser(this)" onmouseover="mouseoveruser(this)" style="padding-top:15px; margin:5px auto 15px 10px;">浅浅</div>
	<div style="background-color:rgb(255,255,255);font-size:90%;">
		<div style="margin:auto auto 5px 10px; float:left">12345678</div>
		<div style="background-color:rgb(255,255,255);clear:both;">
			<div style="float:left">评论我的文章：</div>
			<div style="margin:auto auto 5px 10px; float:left">
				<div style="float:left"></div>
				<div username="浅浅" onmouseout="mouseoutotheruser(this)" onmouseover="mouseoverotheruser(this)" style="float:left; color:LightCoral;">@浅浅</div>
				<div style="float:left">&nbsp;123456789</div>
            </div>
		</div>
	</div>
</div>
