...
def gen_module_caller(module_name, funcs, dependent_struct, dependent_enum):
    ...
    cb_code += "        public readonly MessagePackSerializerOptions op;\n"
    cb_code_constructor = "        public rsp_cb_" + module_name + "(abelkhan.modulemng modules, MessagePackSerializerOptions _op) : base(\"rsp_cb_" + module_name + "\")\n"
    cb_code_constructor += "        {\n"
    cb_code_constructor += "            op = _op;\n"
    ...
    code += "        public readonly MessagePackSerializerOptions op;\n"
    code += "        public " + module_name + "_caller(abelkhan.Ichannel _ch, abelkhan.modulemng modules, MessagePackSerializerOptions _op) : base(\"" + module_name + "\", _ch)\n"
    code += "        {\n"
    code += "            op = _op;\n"
    code += "            if (rsp_cb_" + module_name + "_handle == null)\n            {\n"
    code += "                rsp_cb_" + module_name + "_handle = new rsp_cb_" + module_name + "(modules, _op);\n"
    code += "            }\n"
    code += "        }\n\n"
    ...
    for i in funcs:
        ...
        if i[1] == "ntf":
            ...
            code += "            var __byte_struct__ = MessagePackSerializer.Serialize(__argv_struct__, op);\n"
            ...
            cb_code += "        public readonly Dictionary<string, cb_" + func_name + "> map_" + func_name + ";\n"
            ...
            cb_code_section += "            var _struct = MessagePackSerializer.Deserialize<" + module_name + "_" + func_name + "_struct_rsp>(_event, op);\n"
            ...
            cb_code_section += "            var _struct = MessagePackSerializer.Deserialize<" + module_name + "_" + func_name + "_struct_err>(_event, op);\n"
            cb_code_section += "            var rsp = map_" + func_name + "[_struct._cb_uuid];\n"
