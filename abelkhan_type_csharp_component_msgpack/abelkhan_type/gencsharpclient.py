...
import genenum
import genstruct
import genmothedstruct
import gencallerclient
import genmoduleclient
...
def gen(inputdir, outputdir):
    ...
    for pretreatment in pretreatmentdata:
        ...
        code += genmothedstruct.genmothedstruct(pretreatment)
        code += gencallerclient.gencaller(pretreatment)
        code += genmoduleclient.genmodule(pretreatment)
        code += "\n}\n"
