...
/*this cb code is codegen by abelkhan for c#*/
    public class rsp_cb_uuid : abelkhan.Imodule {
        ...
        public readonly Dictionary<string, cb_sync_uuid> map_sync_uuid;
        public rsp_cb_uuid(abelkhan.modulemng modules, MessagePackSerializerOptions _op) : base("rsp_cb_uuid")
        {
            op = _op;
        ...
        public void sync_uuid_rsp(byte[] _event){
            var _struct = MessagePackSerializer.Deserialize<uuid_sync_uuid_struct_rsp>(_event, op);
            var rsp = map_sync_uuid[_struct._cb_uuid];
            rsp.call_cb();
            map_sync_uuid.Remove(_struct._cb_uuid);
        }
        public void sync_uuid_err(byte[] _event){
            var _struct = MessagePackSerializer.Deserialize<uuid_sync_uuid_struct_err>(_event, op);
            var rsp = map_sync_uuid[_struct._cb_uuid];
    ...
    public class uuid_caller : abelkhan.Icaller {
        ...
        public readonly MessagePackSerializerOptions op;
        public uuid_caller(abelkhan.Ichannel _ch, abelkhan.modulemng modules, MessagePackSerializerOptions _op) : base("uuid", _ch)
        {
            op = _op;
            if (rsp_cb_uuid_handle == null)
            {
                rsp_cb_uuid_handle = new rsp_cb_uuid(modules, _op);
            }
        }
...
/*this module code is codegen by abelkhan codegen for c#*/
    public class rsp_sync_uuid : abelkhan.Response {
        ...
        public rsp_sync_uuid(abelkhan.Ichannel _ch, String _uuid, MessagePackSerializerOptions _op) : base("rsp_cb_uuid", _ch)
        {
            uuid = _uuid;
            op = _op;
        }
        ...
        public void rsp(){
            ...
            var __byte_struct__ = MessagePackSerializer.Serialize(__argv_struct__, op);
            call_module_method("sync_uuid_rsp", __byte_struct__);
        }
        ...
        public void err(Int32 errcode){
            ...
            var __byte_struct__ = MessagePackSerializer.Serialize(__argv_struct__, op);
            call_module_method("sync_uuid_err", __byte_struct__);
        }
    ...
    public class uuid_module : abelkhan.Imodule {
        ...
        private readonly MessagePackSerializerOptions op;
        public uuid_module(abelkhan.modulemng _modules, MessagePackSerializerOptions _op) : base("uuid")
        {
            op = _op;
            modules = _modules;
            modules.reg_module(this);
        ...
        public void sync_uuid(byte[] _event){
            var _struct = MessagePackSerializer.Deserialize<uuid_sync_uuid_struct_req>(_event, op);
            rsp = new rsp_sync_uuid(current_ch, _struct._cb_uuid, op);
            if (onsync_uuid != null){
