...
namespace abelkhan
{
    class AcceptServerHandler : ChannelHandlerAdapter
    {
        ...
        {
            log.trace(new System.Diagnostics.StackFrame(true), timerservice.Tick, "new connection!");
        ...
        {
            log.trace(new System.Diagnostics.StackFrame(true), timerservice.Tick, "ExceptionCaught connection!");
