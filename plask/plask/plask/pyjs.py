...
class pyjs(object):
	def __init__(self, url):
		...
		import appglobal
		appglobal.res_data['JSON.js'] = json
		appglobal.res_data['JSONError.js'] = JSONError
		appglobal.res_data['JSONRequest.js'] = JSONRequest
		appglobal.res_data['JSONRequestError.js'] = JSONRequestError
	...
	def flaskflush(self):
		...
		sflask += "\ttry:\n"
		sflask += "\t\treturn Response(BytesIO(appglobal.res_data['JSON.js']), mimetype='" + mime + "')\n"
		sflask += "\texcept:\n"
		...
		sflask += "\tfrom io import BytesIO\n\timport appglobal\n\timport traceback\n"
		sflask += "\ttry:\n"
		sflask += "\t\treturn Response(BytesIO(appglobal.res_data['JSONError.js']), mimetype='" + mime + "')\n"
		sflask += "\texcept:\n"
		sflask += "\t\tfrom log import log\n\t\tlog(traceback.format_exc())\n\n"	
		...
		sflask += "\tfrom io import BytesIO\n\timport appglobal\n\timport traceback\n"
		sflask += "\ttry:\n"
		sflask += "\t\treturn Response(BytesIO(appglobal.res_data['JSONRequest.js']), mimetype='" + mime + "')\n"
		sflask += "\texcept:\n"
		sflask += "\t\tfrom log import log\n\t\tlog(traceback.format_exc())\n\n"	
		...
		sflask += "\tfrom io import BytesIO\n\timport appglobal\n\timport traceback\n"
		sflask += "\ttry:\n"
		sflask += "\t\treturn Response(BytesIO(appglobal.res_data['JSONRequestError.js']), mimetype='" + mime + "')\n"
		sflask += "\texcept:\n"
		sflask += "\t\tfrom log import log\n\t\tlog(traceback.format_exc())\n\n"	
